...
import com.example.demo.nmtsimulation.distribution.ExponentialProbDistrScaled;
import com.example.demo.nmtsimulation.distribution.LognormalProbDistrScaled;
 ...
 * @author brodo
 */
public class SimParams6Scaled extends SimParams {
    ...
    public ProbabilityFunction PROBcreatorPolicyUpdate(){ return new ExponentialProbDistrScaled(0.1, 0.01, 2);}
    public int GASnewAssetsCreation(){ return 1025897;}
    public ProbabilityFunction PROBnewAssetsCreation(){ return new LognormalProbDistrScaled(1,1, 0.01, 1);}//return new LognormalProbDistr(10,100);}
    public int GASholderPolicyUpdate(){ return 30072 + 381453;}
    public ProbabilityFunction PROBholderPolicyUpdate(){ return new ExponentialProbDistrScaled(0.1, 0.01, 2);}
    public int GAScharacteristicUpdate(){ return 90893;}
    public ProbabilityFunction PROBcharacteristicUpdate(){ return new LognormalProbDistrScaled(1,1, 0.01, 1);}
